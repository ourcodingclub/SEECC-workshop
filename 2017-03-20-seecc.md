...
data <- data[-3796,]      # We should delete these rows and save the file again just for the purpose of the tutorial since they mess up plots
data <- data[-3798,]
data <- data[-3825,]
data <- data[-4193,]
data <- data[-7886,]
...
Pipes pros - more efficient, you can have all your data manipulation, visualisation and graph exporing into one pipe, quicker than loops
   ...
   - lapply
	 - loops
	 - pipes
Mention gradually building the pipe if there are errors to track the source of the error

...
Compare the three data frames to see that they are exactly the same!
...
save(LPI_models_pipes, file = "LPI_models_pipes.csv")  # This can take a while to save
```
...
## 4. Automating data visualisation using `ggplot2` and `dplyr` together
